 ...
 *
 * Description:
 * This file defines all static configuration, UI constants, and layout data used across the app.
 * It centralizes values for navigation, features, image positions, video sequences, and footer links,
 * helping to keep components clean and declarative.
 */
...
// 3D model parts that should not change texture (used in model shaders)
const noChangeParts = [
  "Object_84",
  "Object_37",
  "Object_34",
...
// Images used in the Performance section
...
// Target CSS positions for each performance image (used with GSAP)
...
// Features shown in the animated scroll-sync section (Features.jsx)
const features = [
  {
    id: 1,
...
// Sequence for syncing video texture + scroll animation (used in Features.jsx)
...
// Footer links for legal and policy pages
const footerLinks = [
